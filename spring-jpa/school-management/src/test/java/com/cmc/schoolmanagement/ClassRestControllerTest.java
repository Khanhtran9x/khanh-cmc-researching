...
public class ClassRestControllerTest {
    ...
    @Test
    public void whenPutEmployeeThenUpdateEmployee() throws Exception {
        ClassEntity classEntity = new ClassEntity(1L, "12A1");
        BDDMockito.given(classService.updateClass(classEntity)).willReturn(classEntity);
        ...
        verify(classService, VerificationModeFactory.times(1)).updateClass(Mockito.any());
        reset(classService);
    }
    ...
    @Test
    public void whenInvalidClassIdThenShouldNotReturnClass() throws Exception {
        ClassEntity classEntity = new ClassEntity(1L, "12A1");
        BDDMockito.given(classService.getClassById(classEntity.getClassId())).willReturn(Optional.of(classEntity));
    ...
    @Test
    public void whenDeleteClassByValidId() throws Exception {
        ClassEntity classEntity = new ClassEntity(1L, "12A1");
        BDDMockito.given(classService.getClassById(classEntity.getClassId())).willReturn(Optional.of(classEntity));
        BDDMockito.doNothing().when(classService).deleteClass(Mockito.any());
