package com.micro.paidorderservice.config.kafka;
...
public class KafkaProducerConfiguration {
    @Bean
    public ProducerFactory<String, PaidOrderEntity> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, PaidOrderEntity> kafkaTemplate() {
